...
<section class="about-us">
    <div class="about-us--text">
        <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">Edytowanie użytkownika</h1>
        </div>
        <section class="about-us">
            <div class="about-us--text">
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Edytowanie hasła</h1>
                </div>
                <form method="post" modelAttribute="user">

                    Imię:<input name="firstName" value="${user.firstName}"/><br>

                    Nazwisko:<input name="lastName" value="${user.lastName}"/><br>

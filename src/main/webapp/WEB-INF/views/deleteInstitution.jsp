...
<section class="about-us">
    <div class="about-us--text">
        <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">Usuwanie danych użytkownika</h1>
        </div>
        <p class="h3 mb-0 text-gray-800">
            Czy na pewno chcesz usunąć dane fundacji ${institution.name}?<br>
            <a href="/institution/deleteInstitution?id=${institution.id}">Tak</a>
            <a href="/institution/institutionList">Nie</a>
        </p>
    </div>
</section>
